...
// Pins
static const int led_pin = LED_BUILTIN; //inbuilt LED used
...
//********************* Serial.readString() or Serial.parseInt()can also be used. Here,
// atoi() is used (if non-Arduino environment). You'd
// Serial needs to be replaced with the suitable UART code for non-Arduino.************************ hu
